...
#ifdef DEBUG
    printf("Processing neuron %d on time step %d\n", neuron_id, t);
#endif
...
#ifdef DEBUG
        printf(" - Processing input synapse %d\n", synapse_index);
#endif
...
#ifdef DEBUG
            printf(" - Processing output synapse %d\n", i);
#endif
...
int main(int argc, char *argv[]) {
    ...
    // variable to store information of generated spikes 
    ...
    // add input spike trains to generated spikes
    for(i = 0; i<n_input; i++){
