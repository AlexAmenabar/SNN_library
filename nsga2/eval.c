...
void test_SNN(NSGA2Type *nsga2Params, individual *ind, selected_samples_info_t *selected_samples_info){
    ...
    // The following malloc are depdendent of the need of each objective functions, so pointer functions should be added to allocate memory (and free) and return the pointers, in that way the code will be general
    // for any objective function. // TODO 
    

    // Neccessary arrays for the first objective function // Refactor all this TODO
